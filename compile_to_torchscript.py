...
def parse_args() -> Tuple[Any]:
    ...
    return (name, base_dir, args.out_path, image_size, args.load_from)


def main(model_name: str, base_dir: str, model_save_path: str,
         image_size: Union[int, Tuple[int]]=(256, 256), load_from: int=-1):
    print('in main', model_name, base_dir, model_save_path, image_size, load_from)
