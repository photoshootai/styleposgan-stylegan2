...
def calc_pl_lengths(styles, images):
    ...
    num_pixels = images.shape[2] * images.shape[3]  # H x W
    pl_noise = torch.randn(images.shape, device=device) / math.sqrt(num_pixels)  # device logic in stylegan.py?
